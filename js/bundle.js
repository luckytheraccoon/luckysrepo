...
(function() {
    ...
    for(var i=1;i<=emitters;i++) {
        ...
        var pickedIndex =  getRandomIntInclusive(0, gridSize-1);
        
		var x = document.createElement("div");
        x.id = positions[pickedIndex].id;
        x.style.top = positions[pickedIndex].coords.x * 1 + "px";
        x.style.left = positions[pickedIndex].coords.y * 1 + "px";
        ...
        addPickedPositions(2, pickedIndex);
        gridSize--;
        if(gridSize<1) {
        	break;
        }
